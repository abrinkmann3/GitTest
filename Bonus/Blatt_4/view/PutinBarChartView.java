...
public class PutinBarChartView implements IObserverInterface {
	 ...
	 */
	public PutinBarChartView(IModelInterface model) {
		createComponents();
		m_model = model;
	...
	public void createComponents() {
		m_viewFrame = new JFrame("Putins Bar Chart View");
	...
	public void update(IModelInterface m) {
		...
		double red = m.getRedPercentage()*2;
		double green = m.getGreenPercentage();
		double blue = m.getBluePercentage();
