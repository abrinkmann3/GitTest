 ...
 * 
 * Eine View, die die Daten des Models als Tabelle darstellt und Änderungen an
 * die Sitzplatzanzahl der jeweiligen Partei in Form einer Benutzereingabe
 * entgegennehmen kann.
 * 
...
public class TableView implements IObserverInterface {
	...
	public void createComponents() {
		...
		m_aboutMenuItem.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, m_aboutText, "About", JOptionPane.INFORMATION_MESSAGE);
			}
		});
	...
	/**
	 * Callback-Methode für den Controller, womit ein Fehlertext präsentiert
	...
	/**
	 * Callback-Methode für den Controller, womit ein Fehlertext wieder
	 * zurückgesetzt wird.
	 * 
	 */
